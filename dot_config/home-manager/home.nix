...
in {
  ...
  programs.tmux = {
    ...
    '';
    plugins = with pkgs.tmuxPlugins; [ better-mouse-mode vim-tmux-navigator ];
  };

  # Ghostty terminal (this is always broken for me, and I just use the ubuntu one in mint.)
  ...
  home.file.".kubectl_aliases.fish" = {
    source = pkgs.fetchurl {
      url =
        "https://raw.githubusercontent.com/ahmetb/kubectl-aliases/refs/heads/master/.kubectl_aliases.fish";
